...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "P_NUM_BITS" -parent ${Page_0}
...
proc update_PARAM_VALUE.P_NUM_BITS { PARAM_VALUE.P_NUM_BITS } {
	# Procedure called to update P_NUM_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.P_NUM_BITS { PARAM_VALUE.P_NUM_BITS } {
	# Procedure called to validate P_NUM_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.P_NUM_BITS { MODELPARAM_VALUE.P_NUM_BITS PARAM_VALUE.P_NUM_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.P_NUM_BITS}] ${MODELPARAM_VALUE.P_NUM_BITS}
}
